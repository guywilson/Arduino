...
Exception::Exception(uint32_t errorCode, const string & message)
{
	_initialise();
...
Exception::Exception(uint32_t errorCode, const string & message, const string & fileName, const string & className, const string & methodName, uint32_t lineNumber)
{
	_initialise();
	this->errorCode = errorCode;
	this->message = message;
...
uint32_t Exception::getErrorCode() {
	return this->errorCode;
}

uint32_t Exception::getLineNumber() {
